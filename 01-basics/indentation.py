...
#   Tato funkce zjišťuje, zda je zadané číslo sudé nebo liché
    if cislo % 2 == 0:
        print(f"Číslo {cislo} je sudé.")
    else:
        print(f"Číslo {cislo} je liché.")

# Vypíše docstring funkce sude_liche
print(sude_liche.__doc__)
# Vyvolá funkci sude_liche s parametrem 7
sude_liche(7)